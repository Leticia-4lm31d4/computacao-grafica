 ...
 * @brief Classe para manipulação de vetores tridimensional (x,y,z)
 * @version 0.1
 * @date 2023-10-13
 * 
...
// 4.Multiplicação de um escalar com um vetor

    inline vec3 operator*(double t, const vec3 &v) {
        return vec3(t*v.e[0], t*v.e[1], t*v.e[2]);
    }

// 5.Multiplicação de um vetor com um escalar

    inline vec3 operator*(const vec3 &v, double t) {
        return t * v;
    }

// 6.Divisão de um vetor por um escalar
...
// 8.Calcular o produto vetorial de dois vec3
